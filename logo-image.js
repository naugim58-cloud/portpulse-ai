...
const settingsScript=document.createElement('script');settingsScript.src='settings.js?v=4';document.body.appendChild(settingsScript);
...
const liveEtaScript=document.createElement('script');liveEtaScript.src='live-ops.js?v=5';document.body.appendChild(liveEtaScript);
...
const liveAlertsScript=document.createElement('script');liveAlertsScript.src='live-alerts-fix.js?v=2';document.body.appendChild(liveAlertsScript);
